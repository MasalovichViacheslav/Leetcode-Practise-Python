...
#         ransomNote_count = Counter(ransomNote)
#         magazine_count = Counter(magazine)
#         for letter in ransomNote_count:
#             if letter not in magazine_count or ransomNote_count[letter] > magazine_count[letter]:
#                 return False
#         return True
#
# # testcases
# solution = Solution()
# print(solution.canConstruct("a", "b"), '--> expected', False)
# print(solution.canConstruct("aa", "ab"), '--> expected', False)
# print(solution.canConstruct("aa", "aab"), '--> expected', True)
